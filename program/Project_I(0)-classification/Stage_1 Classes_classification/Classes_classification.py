        ...
        for phase in ['train', 'val']:
            ...
            for idx,data in enumerate(data_loaders[phase]):
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    print(x_classes.shape, labels_classes.shape)
...
#optimizer = optim.SGD(network.model.fc.parameters(), lr=0.001, momentum=0.9)
optimizer = optim.Adam(network.model.fc.parameters(), lr=1e-2, betas=(0.5, 0.999))
criterion = nn.CrossEntropyLoss()
exp_lr_scheduler = lr_scheduler.StepLR(optimizer, step_size=1, gamma=0.1) # Decay LR by a factor of 0.1 every 1 epochs
model, Loss_list, Accuracy_list_classes = train_model(network, criterion, optimizer, exp_lr_scheduler, num_epochs=epoch )
